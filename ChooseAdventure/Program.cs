    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            else if (noiseChoice == "YES")
            {
                ...
                Console.Write("Answer open or knock: ");
            ...
            string keyChoice = Console.ReadLine();
                ...
                switch (keyChoice)
                {
                    //values will be string so must put in quotes
                    case "1":
                    ...
                    case "3":
                        ...
                        break;
                    default:
                        Console.WriteLine("You hesitated. A monster opened the door and ripped your head off. The End.");
                        break;
                }
            }
        }
